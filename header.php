...
<html>
<head>
	<title>Toko Baju Callysta</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +628888812345</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> tokobaju@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Toko Baju Callysta</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #de73ff"><b>Toko Baju Callysta</b></a>
			</div>
